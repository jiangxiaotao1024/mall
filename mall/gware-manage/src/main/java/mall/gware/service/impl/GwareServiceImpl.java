package mall.gware.service.impl;


import com.alibaba.fastjson.JSON;

import mall.gware.util.ActiveMQUtil;
import mall.gware.util.HttpclientUtil;
import mall.gware.bean.WareInfo;
import mall.gware.bean.WareOrderTask;
import mall.gware.bean.WareOrderTaskDetail;
import mall.gware.bean.WareSku;
import mall.gware.enums.TaskStatus;
import mall.gware.mapper.WareInfoMapper;
import mall.gware.mapper.WareOrderTaskDetailMapper;
import mall.gware.mapper.WareOrderTaskMapper;
import mall.gware.mapper.WareSkuMapper;
import mall.gware.service.GwareService;
